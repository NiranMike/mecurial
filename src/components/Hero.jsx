      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full text-center pt-12 md:pt-24 space-y-6 md:space-y-10 px-4 hero-div">
        ...
        >
          <p className="text-lg md:text-xl lg:text-2xl font-light text-white bwmgradual-light">
            Get qualified leads and scale your business by 20-60% increase in
            monthly revenue with our proven ad strategies
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <motion.div
            className="bg-[#050BA5] py-3 px-5 rounded-lg text-white font-medium  Montserrat-light cursor-pointer"
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            ...
            >
              <img
                ...
                alt="Play icon"
              />
              <p className="text-white font-medium Montserrat-light">
                How it Works
              </p>
            </a>
          </motion.div>
