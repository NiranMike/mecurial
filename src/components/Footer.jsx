    ...
    <footer className="bg-black text-white py-8">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-start">
        <img
          src="/footer-logo.png"
          alt="Mercurial logo"
          className="w-[180px] h-[50px] mb-8 md:mb-0"
        />
        ...
        <div className="mb-8 md:mb-0">
          ...
          <ul>
            ...
            <li className="mb-2">
              <a
                href="mailto:support@mercurialtech.co"
                className="hover:underline"
              >
                {" "}
                support@mercurialtech.co
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="container mx-auto px-4 mt-8 border-t border-gray-800 pt-4 text-center">
        <p className="text-sm">
          &copy; Copyright 2024 Mercurial Technologies. All rights reserved.
        </p>
      </div>
    </footer>
  );
