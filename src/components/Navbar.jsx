  ...
  return (
    <div className="relative">
      <div className="flex justify-between px-4 md:px-6 py-4 items-center bg-white shadow-md">
        <img className="w-[100px] md:w-[150px] h-[25px] md:h-[35px]" src="/logo.png" alt="Logo" />
      ...
      {isOpen && (
        ...
        >
          <ul className="flex flex-col items-center gap-5 py-4 text-[#3A3A3A]">
            <li>
              <a href="#services" className="hover:underline" onClick={() => setIsOpen(false)}>Service</a>
            </li>
            <li>
              <a href="#contact" className="hover:underline" onClick={() => setIsOpen(false)}>Contact us</a>
            </li>
            <li>
              <a href="#faqs" className="hover:underline" onClick={() => setIsOpen(false)}>FAQs</a>
            </li>
